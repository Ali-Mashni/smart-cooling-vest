...
static const char* WIFI_SSID        = "Saleh_4G_2";
static const char* WIFI_PASSWORD    = "44332211";
...
static const int SDA2_PIN = 18;

static const int SCL2_PIN = 17;
...
void controlTick() {
 ...
 if (vestState.pumpPct != g_lastAppliedPumpPct) {

 g_lastAppliedPumpPct = vestState.pumpPct;

 Serial.printf("[CTRL] logical pumpPct=%d mode=%s\n", vestState.pumpPct, vestState.mode.c_str());
